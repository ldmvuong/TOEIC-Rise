...
const DictionaryDefinitionDropdown = ({
    ...
    if (loading) {
        return (
            <div className="absolute left-0 right-0 top-full mt-1 z-20 rounded-lg border border-gray-200 bg-white px-3 py-2 shadow-md">
    ...
    return (
        <div className="absolute left-0 right-0 top-full mt-1 z-20 max-h-64 overflow-y-auto rounded-lg border border-gray-200 bg-white shadow-lg">
