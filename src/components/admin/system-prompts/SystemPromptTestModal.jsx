...
const SystemPromptTestModal = ({ open, onClose, systemPromptContent }) => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      if (!aggregatedContent) {
        ...
        console.warn(
          "AI stream ended with warning after delivering content (testing system prompt)."
        );
      }
    } finally {
      setSending(false);
  ...
  return (
    <Modal
      ...
      centered
      closable
      title="Test Chatbot System Prompt"
      bodyStyle={{ padding: 0 }}
    >
      <div className="flex flex-col h-[70vh]">
        <div className="px-6 py-3 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50 flex items-center justify-between">
          <div>
            <div className="text-sm font-semibold text-gray-900">
              Chatbot Tester
            </div>
            <div className="text-xs text-gray-500">
              This chat uses the selected system prompt content.
            </div>
          </div>
          {!systemPromptContent && (
...
export default SystemPromptTestModal;
