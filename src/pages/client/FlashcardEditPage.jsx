...
import { callFetchFlashcardDetail, callUpdateFlashcard } from "../../api/api";
  ...
  const fetchFlashcardData = async () => {
    ...
    try {
      ...
      if (error?.statusCode === 404) {
        ...
        message.error(
          error?.message || "Unable to load flashcard set information!",
        );
        ...
        <Card className="max-w-md w-full shadow-lg rounded-xl border-gray-200">
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 mb-6">
              This flashcard set does not exist or you do not have permission to
              access it.
            </p>
            <Button
              type="primary"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pl-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-xs text-gray-400 italic pt-2">
                    * Tip: You can enter an example sentence in the definition
                    field if needed.
                  </div>
                </div>
